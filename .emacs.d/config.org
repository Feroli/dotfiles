...
This emacs configuration is largely influenced by [[https://github.com/danielmai/.emacs.d][Mai's emacs configuration]]
...
(setq user-full-name "Fernando Ania"
      user-mail-address "fernando.ania@paxport.net")
#+end_src
...
Changes the frame from a horizontal view to a vertical split and vice versa
...
From [[https://github.com/serras/emacs-haskell-tutorial/blob/master/tutorial.md][haskell for emacs]]
...
Allow the hash key to be entered
